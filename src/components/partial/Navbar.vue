      ...
      <div id="navbarBasicExample" class="navbar-menu">
        ...
        <div class="navbar-end menu">
          <div class="navbar-item contact">
              <a class="navbar-item contact-info"><i class="fa fa-envelope icon" style="margin-right: 8px;"></i> info@mekong.digital</a>
              <a class="navbar-item contact-info"><i class="fa fa-phone-square" style="margin-right: 8px;"></i>+8562099392245</a>
          </div>
        </div>
      </div>
    </nav>
